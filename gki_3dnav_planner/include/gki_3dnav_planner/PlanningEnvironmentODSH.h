...
#ifndef TERRAINMAPPLANNINGENVIRONMENT_ODSH_H_
#define TERRAINMAPPLANNINGENVIRONMENT_ODSH_H_
...
class PlanningEnvironmentODSH : public PlanningEnvironment
{
public:
    PlanningEnvironmentODSH(
            const CollisionChecker* checker,
            SBPLPlanner* heuristicPlanner,
            PlanningEnvironment* heuristicEnvironment);
    virtual ~PlanningEnvironmentODSH();
...
#endif /* TERRAINMAPPLANNINGENVIRONMENT_ODSH_H_ */
